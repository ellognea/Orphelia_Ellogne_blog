...
The raw data was stored in a large PostgreSQL database consisting of many tables. It took our team time throughout the course of the project to understand the data. We continuously went back to the original data to add and subtract different components from it. Below are some of the insights we uncovered: 
